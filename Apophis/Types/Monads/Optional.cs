...
namespace Apophis.Types.Monads
{
        ...
        where TCheckPolicy : struct, ICheckPolicy
    {
        ...
        public override int GetHashCode() => _hasValue && _value != null ? _value.GetHashCode() : 689435;
        ...
        [System.Runtime.CompilerServices.MethodImpl(System.Runtime.CompilerServices.MethodImplOptions.AggressiveInlining)]
        public Try<T, TCheckPolicy> ToTry() => _hasValue ? new Try<T, TCheckPolicy>(_value) : new Try<T, TCheckPolicy>(new NullReferenceException());
